...
class LoginPageMesto:
    ...
    reg_button = [By.CLASS_NAME, 'header__auth-link']
    ...
    def check_text_registration_button(self):
        registration_button_text = self.driver.find_element(*self.reg_button).text
        assert registration_button_text == 'Регистрация'
